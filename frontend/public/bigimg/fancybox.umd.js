        ...
        o(this, t),
          ...
          (this._pointerEnd = function (t) {
            (t.buttons > 0 && 0 !== t.button) ||
              (i._triggerPointerEnd(new E(t), t) && (window.removeEventListener("mousemove", i._move, { passive: !1 }), window.removeEventListener("mouseup", i._pointerEnd, { passive: !1 })));
          }),
          ...
          },
          {
            ...
            value: function () {
              ...
              r.forEach(function (t) {
                var e = i({}, t);
                g && e.left === g.left
                  ? ((g.width += e.width), (g.slides = [].concat(m(g.slides), m(e.slides))), (g.indexes = [].concat(m(g.indexes), m(e.indexes))))
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                !t.Carousel.prevPage && (t.option("slideshow.autoStart") && this.Slideshow.activate(), t.option("fullscreen.autoStart") && !Q.element()))
              )
                try {
