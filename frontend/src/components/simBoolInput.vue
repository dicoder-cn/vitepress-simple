<template>
  <div class="flex justify-start" :style="StyleNoDrag">
    <sim-switch :label="props.boolLabel" :tooltip="props.boolTooltip" v-model="useChecked"></sim-switch>

    <sim-input :tooltip="props.inputTooltip" v-model="useInput" :label="props.inputLabel" :disabled="!useChecked"></sim-input>
  </div>
</template>
