...
export const en = {
  ...
  pageIndex: {
    ...
    addMeta: "Add Meta",
    customFormatterTip: "Variable data is stored in 'custom' attribute, accessed via {frontmatter}.custom.{xx}",
  ...
  pageSidebar: {
    ...
    confirmSwitchSidebar: "Switching will [Clear] the current language's sidebar data",
    ...
    recognitionWarning: "Detected sidebar data will overwrite current sidebar data",
    ...
    mode: "Mode",
    noSubDirectoryTip: "No subdirectories found under this path, please create first!",
  ...
  pageProject: {
    ...
    projectRootDirectory: "Project root where .vitepress special directory is sought",
    chooseRootDirectory: "Choose Root Directory",
    sourceDirectory: "Source Directory (Docs)",
    sourceDirectoryHint: "Source directory for Markdown files, default is ./docs, can be changed after creation",
    ...
    errorProjectNotVPSimple: "If the project wasn't created by VPSimple, config files may fail to load",
    ...
    settingBase: {
      ...
      tooltips: {
        ...
        titleSuffix: "Allows customization of page title suffix or the entire title",
        outlineLevel: "Outline display level",
        htmlLang: "The lang attribute of the site. This will appear as the <html lang='xx'> tag in page HTML",
        siteDescription: "Site description, used in <meta> tags in page HTML",
        externalLinkIcon: "Whether to display an external link icon next to external links in markdown",
        docPath: "Markdown document directory. Ensure image resources are accessible; do not change arbitrarily after setup",
        baseUrl: "Base URL the site will be deployed at. If deploying to a subpath, set this",
        buildPath: "Project build output location, relative to the project root",
        hostname: "Used when generating a sitemap.xml file for the site",
        staticAssets: "Specifies the directory to place generated static assets. The path should be within the build path and resolved relative to it",
    ...
    settingLang: {
      ...
      tooltips: {
        ...
        i18nRouting: "When enabled, routes will automatically include the directory name, e.g., changing the local language to zh will change the URL from /foo (or /en/foo/) to /zh/foo.",
        siteTitleInfo: "The site title displayed after the logo, equivalent to themeConfig.siteTitle.",
        footerMessageInfo: "Due to design, the footer is only shown when the page does not contain a sidebar.",
        copyrightInfo: "Shown in the footer due to design constraints, visible only when the sidebar is absent.",
        langMenuLabelInfo: "Custom aria-label for the language switch button in the navbar, used only when i18n is enabled.",
        returnToTopLabelInfo: "Custom label for the back-to-top button, visible only in mobile views.",
        sidebarMenuLabelInfo: "Custom label for the sidebar menu, visible only in mobile views.",
        darkModeSwitchLabelInfo: "Custom label for the dark mode switch, visible only in mobile views.",
        lightModeSwitchTitleInfo: "Custom title for the light mode switch when hovered.",
        darkModeSwitchTitleInfo: "Custom title for the dark mode switch when hovered.",
        editLinkTextInfo: "Edit link enables displaying a link to edit the page on Git management services like GitHub or GitLab.",
      ...
      labels: {
        ...
        removeConfirm: "All data including configuration, navigation, sidebar, etc., will be deleted.",
    ...
    settingSearch: {
      ...
      tooltips: {
        tooltips: "VitePress supports fuzzy full-text search using browser indexing (local).",
        AlgoliaAppId: "Algolia Search AppId, found in settings -> Team and Access -> API keys -> Application ID.",
        AlgoliaSearchKey: "Algolia Search apiKey, found in settings -> Team and Access -> API keys -> Search-Only API Key.",
        AlgoliaIndexName: "Algolia Search indexName, the name of the created index."
      }
    },
    settingSocial: {
  ...
  pageSetting: {
    settingBase: {
      ...
      editorCdn: {
        label: "Editor CDN:",
        tooltip: "If the markdown editor fails to load, manually switch the editor CDN and then 【Restart】 the program."
      },
      sysUpdateSource: {
        label: "Update Source:",
        tooltip: "Chinese users are recommended to use Gitee source for updates, while non-Chinese users should prefer GitHub."
      },
