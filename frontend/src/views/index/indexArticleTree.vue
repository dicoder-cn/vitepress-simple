<template>
  <div v-if="!isEmptyArray(storeIndex.articleTreeData)" class="mt-1 hide-scrollbar-x">
    <a-tree
      ...
      <template #title="{ key: treeKey, title }">
        ...
        <q-menu touch-position context-menu>
          <q-list dense style="min-width: 100px">
            ...
            <q-separator />
            <q-item clickable @click="showPopRename(title, treeKey)" v-close-popup>
              <menu-item :title="lang('pageIndex.rename')" icon="file-editing"></menu-item>
            </q-item>
            <q-separator />
            ...
            <q-item clickable @click="deletePath(treeKey)" v-close-popup>
              <menu-item :title="lang('pageIndex.delete')" icon="delete-five"></menu-item>
            </q-item>
          </q-list>
        </q-menu>
        <div
