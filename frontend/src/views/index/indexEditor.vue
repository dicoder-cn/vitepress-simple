...
<template>
  <div style="height: 100vh; overflow-y: hidden">
    <!--    顶部工具栏-->
    <index-editor-tool class="sticky z-10 top-0 py-2 px-2 border-b w-full"></index-editor-tool>

    <!--    编辑器写作和预览区-->
    <q-splitter ref="refSplitterEditor" :unit="'%'" style="height: 100vh" :model-value="storeLayout.EditorLeftWriterWidth">
      <template v-slot:before>
        <!--编辑器写作区，确保内容区域高度自适应-->
        <!-- <index-editor-writer></index-editor-writer> -->
        <index-editor-writer v-if="useAppConfigStore().editorType === editorType.Vditor"></index-editor-writer>

        <index-editor-writer-mdeditor v-else></index-editor-writer-mdeditor>
      </template>
