<template>
  ...
  <a-modal
    ...
    <a-radio-group v-model:value="currShellIndex" button-style="solid">
      <a-radio-button v-for="(value, key) in storeShell.messages" :key="key" :value="Number(key)"
        >shell{{ key }}
      </a-radio-button>
    </a-radio-group>
    ...
    <!--    底部按钮操作组-->
    <div
      v-show="Object.keys(storeShell.messages).length > 0 && storeIndex.systemType != SystemWindows"
