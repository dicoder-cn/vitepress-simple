<template>
  <div>
    ...
    <div
      ...
      v-show="storeConfig.configData['themeConfig']['search']['provider'] == 'algolia'">
      <sim-input
        v-model="storeConfig.configData['themeConfig']['search']['options']['appId']"
        :tooltip="lang('pageProject.settingSearch.tooltips.AlgoliaAppId')"
        label="AppId">
      </sim-input>
      <sim-input
        v-model="storeConfig.configData['themeConfig']['search']['options']['apiKey']"
        :tooltip="lang('pageProject.settingSearch.tooltips.AlgoliaSearchKey')"
        label="apiKey">
      </sim-input>
      <sim-input
        v-model="storeConfig.configData['themeConfig']['search']['options']['indexName']"
