<template>
  <div class="m-3">
    <a-alert
      ...
      closable
      :show-icon="false"
      :description="lang('pageProject.settingLang.tooltips.multiLanguageEnabled')"></a-alert>
  </div>
  <dy-add-k-v
...
<script setup lang="ts">
  ...
  const saveLangConfig = () => {
    ...
    if (storeConfig.IsUseI18n) {
      if (storeConfig.currSettingLang == '' || storeConfig.currSettingLang == StringGlobalLang) {
