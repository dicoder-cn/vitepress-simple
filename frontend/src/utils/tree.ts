...
export class TreeUtil {
   ...
   */
  static updateNodeByKey(data: DataNode[], key: string | number, updateInfo: Partial<DataNode>): boolean {
    for (const node of data) {
      if (node.key === key) {
   ...
   */
  static addNodeToParentByKey(data: DataNode[], parentKey: string | number, newNode: DataNode): boolean {
    for (const node of data) {
